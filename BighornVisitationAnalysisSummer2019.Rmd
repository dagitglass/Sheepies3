...
boxplot(Percentvisited ~ Month, data = marbindsheepvisitperday1)
...
boxplot(Percentvisited ~ Month, data = nopaindsheepvisitperday2)
...
# right-skewed b/c very small sample size
boxplot(Percentvisited ~ Month, data = cmprindsheepvisitperday2)
