...
-KI_DatObsT_ID has 1858 levels, but there are 2062 entries
- GO_DatObsTime and KI_DatObsT_ID are wrong for some entries. Need to remake in order to use!

In an attempt to figure out why there was still duplicated rows, I made a column with everything needed to make each observation individually identifiable. I discovered that some rows did not have the capture data needed, and that this was what was making the duplicated rows not seen as duplicated. I then worked to input the missing information - weight, body length, and chest girth.
...
# LIST OF SHEEP THAT HAVE MEASUREMENTS (* sheep that had different measurements?): BHS_1428*, BHS_1490*, 1493*, 1494*, 1563, 1565, 1574, 1575, 1576, 1577, 1581, 1582, 1583, 1587, 1592, 1594, 1682, 1683, 1684, 1689, 1713, 1730, 1731, 1733, 1734, 1736, 1738, 1739 
...
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1428"] <- "149.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1490"] <- "158.2"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1493"] <- "162.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1494"] <- "145.1"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1563"] <- "165.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1565"] <- "136.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1574"] <- "146.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1575"] <- "143.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1576"] <- "141.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1577"] <- "141.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1581"] <- "139.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1582"] <- "138.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1583"] <- "142.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1587"] <- "139.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1592"] <- "137.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1594"] <- "125.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1682"] <- "140.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1683"] <- "144.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1684"] <- "149.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1689"] <- "155.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1713"] <- "140.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1730"] <- "152.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1731"] <- "161.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1733"] <- "153.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1734"] <- "149.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1736"] <- "118.0"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1738"] <- "130.5"
nodups$CP_Weight..kg.[nodups$KI_Known_ID == "BHS_1739"] <- "145.0"

# BHS_1428 Weight comes back as 63 and 89, chest girth comes back as 100.0 and 108.3.
          ...
          View(missmeasures)
  nodups[nodups$CP_BdyLgth_cm == "NA"]
nodups$CP_BdyLgth_cm[nodups$KI_Known_ID == "BHS_1489"] <- ""

nodups$KI_Sex[nodups$DateObsTimeIDwaterspecific == "20190613BHS_14899:16NaanNA"] <- "F"
...
as.factor(nodups$KI_Known_ID)
# df[df$Name == "John_Smith" & df$State == "WI",1] <- "John_Smith1"
# nodups[nodups$DateObsTimeIDwaterspecific == "20190613BHS_14899:16NaanNA", is.na(nodups$KI_Sex) == TRUE] <- "F" 



# this changes every KI_Sex to female - wrong!
# if(nodups$DateObsTimeIDwaterspecific == "20190613BHS_14899:16NaanNA"){nodups$KI_Sex <- "F"}
...
``` {r}
missmeasures <- nodups[nodups$KI_Known_ID | nodups$CP_Weight..kg. | nodups$CP_BdyLgth_cm | nodups$CP_ChstGth_cm]
