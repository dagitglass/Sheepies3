...
## It is worth noting that I have not deleted replicate observations from Theresa from this dataset. So if a sheep went to 'Theresa Seep' and 'Theresa Drinker Box' within the same visit, it still counts as two visits to water. NEED TO FIX AT SOME POINT.
...
# boxplot(MarbNumVisitbyID1$Freq)
...
# boxplot(NopaNumVisitbyID1$Freq)
...
# boxplot(CMPRNumVisitbyID1$Freq)
...
title("Total Number of Visits to Water by Individual Bighorn", line = -1, outer = TRUE)
