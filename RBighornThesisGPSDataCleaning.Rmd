...
Sheep 1589 switched from 4 hour fix rate to 1 hour fix rate on 2019-06-15 16:00:00.
...
# First differentiated between BHS_1589 and all other sheep
just1589 <- dopall[dopall$ID == "BHS_1589", ]
dopall1 <- dopall[dopall$ID != "BHS_1589", ]
...
# 1 hour fix rate
dopall2 <- dopall1[dopall1$ID == "BHS_1584" |  dopall1$ID == "BHS_1582" | dopall1$ID == "BHS_1577" | dopall1$ID == "BHS_1683" | dopall1$ID == "BHS_1682" | dopall1$ID == "BHS_1684" | dopall1$ID == "BHS_1688" | dopall1$ID == "BHS_1685" | dopall1$ID == "BHS_1689" | dopall1$ID == "BHS_1687" | dopall1$ID == "BHS_1686" | dopall1$ID == "BHS_1736" | dopall1$ID == "BHS_1740" | dopall1$ID == "BHS_1739" | dopall1$ID == "BHS_1730" | dopall1$ID == "BHS_1733", ]
cln1hrfix <- rbind(dopall2, just1589after)
# 4 hour fix rate
dopall3 <- dopall1[dopall1$ID == "BHS_1581" | dopall1$ID == "BHS_1595" | dopall1$ID == "BHS_1588" | dopall1$ID == "BHS_1580" | dopall1$ID == "BHS_1738" | dopall1$ID == "BHS_1568" | dopall1$ID == "BHS_1565" | dopall1$ID == "BHS_1567" | dopall1$ID == "BHS_1564" | dopall1$ID == "BHS_1677", ]
clan4hrfix <- rbind(dopall3, just1589before)
...
# There are 6691 fixes for South Bristols.


nrow(cln1hrfix)
# Total Actual = 14694 fixes
# Total fixes there should be:
# 16 sheep not including 1589: 
