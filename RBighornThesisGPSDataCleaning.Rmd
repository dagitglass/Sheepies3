...
rangeidhour <- subset(allidgpsdatacut2, format(allidgpsdatacut2$DateTimeLocalTest, "%M") %in% c('00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '55', '56', '57', '58', '59', '54', '53', '52', '51', '50'))
...
nrow(pmarbidhour)
#5688 points for Marbles before cleaning.
...
```
First, I cleaned them using elevation data. If the 
